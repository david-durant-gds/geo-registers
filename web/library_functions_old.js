...
// The only difference to the function above is that it cascades to a different select
function updateSelectOfRegistersWithBoundaries2() {
  var jqxhr = $.get("registers-with-a-boundary.txt")
    .done(function(data) {
...
// Fill the list of registers with locations
function updateSelectOfRegistersWithLocation() {
  var jqxhr = $.get("registers-with-a-location.txt")
    .done(function(data) {
